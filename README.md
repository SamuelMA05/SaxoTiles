...
1) El dispositivo será portátil, y se alimentará a través de baterías recargables.
2) El dispositivo contará con LEDS RGB direccionables, con el fin de proporcionar un mejor estilo visual y añadir funcionalidades mediante los colores.
3) Se implementará una salida de audio mediante un conector tipo Jack, de modo que el usuario pueda escuchar la melodía con audífonos. Además, se incluirá un potenciómetro que permitirá regular el volumen de la salida de audio.
4) El dispositivo creará su propia red de Wi-Fi, con el fin de poder correr una pequeña aplicación web desde una computadora.
